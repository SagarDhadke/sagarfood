...
class GLF_Restaurant_System {
	...
	public function glf_system_init() {
        ...
        add_action( 'upgrader_process_complete', array( 'GLF_Restaurant_System', 'glf_upgrader_process_complete'), 10, 2 );
        add_action( 'plugins_loaded', array( 'GLF_Restaurant_System', 'glf_plugins_loaded' ) );
	}
